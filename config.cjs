...
const config = {
  SESSION_ID: process.env.SESSION_ID || "ETHIX-MD&wCsJiZF6",
  ...
  OWNER_NAME: process.env.OWNER_NAME || "✪⏤Sadeesha★⃝✪͜͡➺",
  OWNER_NUMBER: process.env.OWNER_NUMBER || "94779062397,94768211853",
